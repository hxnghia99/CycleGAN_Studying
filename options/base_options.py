...
class BaseOptions():
    ...
    def initialize(self, parser):       #Create override function in child_class and call this function 
        ...
        # basic parameters
        parser.add_argument('--dataroot', type=str, default="./datasets/nonfire2fire_bbox", required=False, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='nonfire2fire_bbox', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--label_type', type=str, default='bbox', help='choose the type of annotation file to read. [bbox | segmentation]')
        parser.add_argument('--process_mode', type=str, default='5', help='define training methods using whole image, bbox, segmentation,... : 0 (whole-image) | 1 (apply-seg-after-G) | 2 (apply-seg-before-G) | 3 (apply-bbox-after-G) | 4 (apply-bbox-before-G) | 5 (apply-bbox-crop-resize)')
        parser.add_argument('--direction', type=str, default='AtoB', help='AtoB or BtoA')
        parser.add_argument('--serial_batches', action='store_true', help='if true, takes images in order to make batches, otherwise takes them randomly')
        parser.add_argument('--num_threads', default=4, type=int, help='# threads for loading data')
        parser.add_argument('--batch_size', type=int, default=1, help='input batch size')
        parser.add_argument('--load_size', type=int, default=416, help='scale images to this size')
        parser.add_argument('--crop_size', type=int, default=416, help='then crop to this size')
        parser.add_argument('--max_dataset_size', type=int, default=float("inf"), help='Maximum number of samples allowed per dataset. If the dataset directory contains more than max_dataset_size, only a subset is loaded.')
        parser.add_argument('--preprocess', type=str, default='resize_and_hflip', help='scaling and cropping of images at load time [resize_and_crop | crop | scale_width | scale_width_and_crop | none]')
