...
class BaseOptions():
    ...
    def initialize(self, parser):       #Create override function in child_class and call this function 
        ...
        # basic parameters
        parser.add_argument('--dataroot', type=str, default="./datasets/nonfire2smallfire", required=False, help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        parser.add_argument('--name', type=str, default='nonfire2smallfire', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--preprocess', type=str, default='resize_and_crop_and_hflip', help='scaling and cropping of images at load time [resize_and_crop | crop | scale_width | scale_width_and_crop | none]')
